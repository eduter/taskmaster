...
Commercial todo apps are either wrong-shaped or unstable. Trello automation is painful for real scheduling. I want something that matches how I actually work: a simple daily list, strong recurrence, easy postponement, and sync across Linux, Windows, and Android — without a backend I have to maintain.
